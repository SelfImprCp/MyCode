package org.cpblog.ui.widget.listview;
...
import org.cpblog.ui.widget.listview.ILoadingLayout.State;
...
/**
 * @see {@link #PullToRefreshListView} 这个类实现了ListView下拉刷新，上加载更多和滑到底部自动加�?
 * 
...
public class PullToRefreshList extends PullToRefreshBase<ListView> implements
    ...
    private ListView mfakeListView; // �?个伪造的ListView(实际上是包含了一个ListView)
